...
function Login(){
    ...
    const doLogin=()=>{
       ...
       myformdata.append("user_password",password)
        axios.post("https://akashsir.in/myapi/atecom1/api/api-login.php",myformdata)
        .then(res=>{
           console.log(res);
            if(res.data.flag === "1")
            {
                localStorage.setItem("uid",res.data.user_id);
                localStorage.setItem("ueamil",res.data.user_name);
                localStorage.setItem("upass",res.data.user_email);  
                navigate('/Home');
            }else{
                alert("Failed")
            }
          ...
          <ul className="navbar-nav me-lg-auto my-2 my-lg-0 navbar-nav-scroll">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><a className="dropdown-item" href="peri peri veg.html">peri peri veg pizza</a></li>
                <li><a className="dropdown-item" href="paneer tikka.html">paneer tikka pizza</a></li>
      ...
      <div className="form-wrapv">
        ...
        <form action="#" onSubmit={doLogin}>
          ...
          <div className="form-sub-content">
            <p className="forgot-w3ls">Forgot Password?<a className href="#"> Click here</a></p>
            <p className="forgot-w3ls1">New User? <a className href="/Signup">Signup here</a></p>
          </div>
          <div className="submit-button text-center">
            <button type='submit' className="btn btn-style btn-primary">Login Now</button>
          </div>
        </form>
      </div>
      {/*//form-ends-here*/}
