  ...
  function Contact(){
    ...
    const doValidation=()=>{
      var temperror={}
       ...
       if(!phonenumber){
        isValid=false;
        temperror.phonenumber="Enter phonenumber";
       }
       if(!subject){
        isValid=false;
       ...
       if(isValid===true)
       {
        localStorage.setItem("Contact",JSON.stringify(name,email,phonenumber,subject,typeofmessage));
        window.alert("contact successfully");
       }
       else{
        ...
        <div className="contact-right mt-lg-4">
          <form action="https://sendmail.w3layouts.com/submitForm" method="post" className="signin-form" onSubmit={doValidation}>
            <div className="input-grids">
              ...
              <input type="text" name="w3lPhone" id="w3lPhone" onChange={(e)=>setPhonenumber(e.target.value)}placeholder="Enter your Phone Number *" required />
